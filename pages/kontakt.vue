            ...
            <v-row>
              <v-col cols="12" md="6">
                <v-text-field
                  ...
                  variant="solo"
                  required
                  :rules="[(v) => !!v || t('contact.form.rules.required')]"
                ></v-text-field>
              </v-col>
              <v-col cols="12" md="6">
              ...
              <v-col cols="12" md="6">
                <v-text-field
                  ...
                  required
                  :rules="[
                    (v) => !!v || t('contact.form.rules.required'),
                    (v) => /.+@.+\..+/.test(v) || t('contact.form.rules.email'),
                  ]"
                ></v-text-field>
              </v-col>
              <v-col cols="12" md="6">
              ...
              <v-col cols="12">
                <v-checkbox
                  ...
                  value="agree"
                  density="compact"
                  :rules="[(v) => !!v || t('contact.form.rules.requiredAgree')]"
                ></v-checkbox>
              </v-col>
              <v-spacer></v-spacer>
